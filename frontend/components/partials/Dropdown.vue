...
.dropdown-toggle {
  ...
  font-weight: 700;
  border: 0;
  background-image: linear-gradient(#6000de, #6000de), linear-gradient(#D2D2D2, #D2D2D2);
...
.dropdown-toggle:hover, .menuActive {
  background-image: linear-gradient(#6000de, #6000de), linear-gradient(#6000de, #6000de);
  cursor: pointer;
}
.dropdown-menu {
  position: absolute;
