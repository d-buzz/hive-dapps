<template>
  <div class="component-app-submit">
    <div class="app-submit-wrapper">
      <div v-if="false" class="app-submit__info">
          Do you want to submit an App already on Steem? Then please submit all the fields again.
      </div>
      ...
      <div class="app-submit-container">
        ...
        <div class="input-container">
          ...
          <input class="input" v-model="app.display_name" placeholder="e.g. Splinterlands"/>
        </div>
        <div class="input-container">
        ...
        <div class="input-container">
          ...
          <textarea class="textarea" v-model="app.description" placeholder="Splinterlands is a collectible trading multiplayer card game with design that will make you think of a symbiosis between pokemon card games and World of Warcraft characters. The game has a developed storytelling based on a mystical world. Initially built on the Steem blockchain to offer fast transactions and full transparency. Get in the game, conquer a world or solve quests."/>
        </div>

        <div class="input-container">
          <p class="input-label">App URL <span class="required-tag">(required)</span></p>
          <input class="input" v-model="app.link" placeholder="https://splinterlands.com"/>
        </div>
        ...
        <div class="input-container">
          ...
          <ul class="accounts-container">
            <li class="account" v-for="a in app.accounts" :key="a.id">
              <input placeholder="e.g. splinterlands" v-model="a.name"/>
        ...
        <div style="display:flex; justify-content:center; flex-flow:column;">
          <div class="button darkgrey_button" style="min-width:150px;" @click="submitApp()">
            <span>Submit</span>
          </div>
          <div class="cancel">
...
export default {
  ...
  data() {
    return {
      ...
      app_types: ['app', 'interface', 'steemengine', 'project', 'extension'],
      account_types: [
        {
          name: 'meta',
          desc: 'The accounts name is being used for meta-data (e.g. splinterlands/0.1)'
        },
        {
          name: 'posting',
